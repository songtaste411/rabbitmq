...
public class MsgProducer {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.130.130:9092,192.168.130.130:9093,192.168.130.130:9094");
         /*
         发出消息持久化机制参数
        ...
        *//*
        ...
        for (int i = 1; i <= msgNum; i++) {
            OrderMessageDTO order = new OrderMessageDTO();
            order.setOrderId(i);
            //指定发送分区
